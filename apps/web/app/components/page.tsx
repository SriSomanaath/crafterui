...
export const metadata: Metadata = {
  title: "Components",
  description:
    "Motion and interaction components you can customize, extend, and build on. Open any for the live demo and the source you can copy or install with npx @crafterui/cli.",
