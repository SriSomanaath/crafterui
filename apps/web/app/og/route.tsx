...
const SITE_DESCRIPTION =
  "Open Source motion and interaction components you can customize, extend, and build on. React + Tailwind, on the shadcn registry.";

// White field, mono brand kicker, medium headline, quiet gray description -
// same composition as the landing. Also the site-wide default (no ?component).
...
export async function GET(request: Request) {
  try {
    ...
    const jsx = !slug
      ? ComponentOGImage("Less is more", truncate(SITE_DESCRIPTION))
      : component
